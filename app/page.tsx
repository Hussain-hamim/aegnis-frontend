  ...
  return (
    <div className="min-h-screen night-sky-bg">
      ...
      <section className="relative overflow-hidden py-20 lg:py-32">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Badge
              variant="secondary"
              className="mb-6 animate-float bg-white/10 text-white border-white/20 backdrop-blur-sm"
            >
            ...
            <p className="text-xl text-gray-300 text-balance max-w-3xl mx-auto mb-8">
              Aegnis is a "contact-center grade" AI stack for personal productivity. Write simple commands to build and
              orchestrate your entire digital workflow. We'll handle the complexity while you focus on what matters.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="text-lg px-8 py-6 bg-white text-gray-900 hover:bg-gray-100 font-medium">
                Start Building
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-green-400 font-medium">Aegnis AI Active</span>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-900/50 rounded-lg p-4 border border-white/10">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="text-sm text-purple-300 font-mono">Function: manage_emails</span>
                      </div>
                    ...
                    <div className="bg-gray-900/50 rounded-lg p-4 border border-white/10">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="text-sm text-blue-300 font-mono">Function: optimize_calendar</span>
                      </div>
                      <div className="text-xs text-gray-400 font-mono">
                    ...
                    <div className="bg-gray-900/50 rounded-lg p-4 border border-white/10">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className="text-sm text-green-300 font-mono">Function: sync_life_data</span>
                      </div>
                      <div className="text-xs text-gray-400 font-mono">
                ...
                <div className="bg-gray-900/30 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold text-white">Today's Impact</h3>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border-t border-white/10 pt-3 mt-3">
                      <div className="flex items-center justify-between">
                        <span className="text-purple-300 font-medium">Time saved today</span>
                        <span className="text-purple-300 font-bold text-lg">3.5 hours</span>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section id="features" className="py-20 lg:py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">The Magic Behind Aegnis</h2>
            <p className="text-xl text-gray-300 text-balance max-w-2xl mx-auto">
              Powerful AI that learns your preferences and takes action on your behalf
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 scroll-animate bg-white/5 border-white/10 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardTitle className="text-white">Autonomous Calendar</CardTitle>
                <CardDescription className="text-gray-300">
                  Smart scheduling that protects your time and optimizes your day
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 scroll-animate bg-white/5 border-white/10 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Unified view of tasks, health, finances, and goals in one place
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 scroll-animate bg-white/5 border-white/10 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription className="text-gray-300">
                  Gets better over time by learning from your preferences and feedback
                </CardDescription>
              </CardHeader>
            </Card>
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Trusted by Professionals Worldwide</h2>
          </div>
      ...
      <section id="testimonials" className="py-20 lg:py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Loved by Busy Professionals</h2>
            <p className="text-xl text-gray-300">See how Aegnis transforms daily productivity</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="scroll-animate bg-white/5 border-white/10 backdrop-blur-sm">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-300 mb-4">
                  "Aegnis has completely transformed how I manage my day. It's like having a personal assistant who
                  never sleeps."
                </p>
            ...
            <Card className="scroll-animate bg-white/5 border-white/10 backdrop-blur-sm">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-300 mb-4">
                  "I save 3 hours every day on email management alone. The AI drafts are so accurate, I rarely need to
                  edit them."
                </p>
                <div className="flex items-center">
            ...
            <Card className="scroll-animate bg-white/5 border-white/10 backdrop-blur-sm">
              <CardContent className="pt-6">
                ...
                <p className="text-gray-300 mb-4">
                  "The calendar optimization is incredible. It automatically blocks focus time and declines low-priority
                  meetings."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Designer, Creative Agency</div>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 lg:py-32 relative">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center scroll-animate">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Ready to Transform Your Productivity?</h2>
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of professionals who've already made the switch to intelligent automation.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="text-lg px-8 py-6 bg-white text-gray-900 hover:bg-gray-100 font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Your AI-powered operating system for life and work.</p>
            </div>
            <div>
